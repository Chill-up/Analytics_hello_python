...
lang_selector = int(input('Выберите язык!\nВведите 1 для русского и 2 для английского\n'))
if lang_selector == 1 or 2:
    lang = lang_selector

word = input('Введите слово:\n')
word = word.upper()  # приводим к верхнему регистру, как в словаре.
